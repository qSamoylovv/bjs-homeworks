...
let personData = getPersonData({ aaa: 0, bbb: 1 });

function getDecodedValue(secret) {
  if (secret[0] === 0 && secret[1] === 1) {
    secret[0] = 'Родриго';
    secret[1] = 'Эмильо';
  } else if (secret[0] === 1 && secret[1] === 0) {
    secret[0] = 'Эмильо';
    secret[1] = 'Родриго';
  } else if (secret[0] === 0 && secret[1] === 0) {
    secret[0] = 'Родриго';
    secret[1] = 'Родриго';
  } else if (secret[0] === 1 && secret[1] === 1) {
    secret[0] = 'Эмильо';
    secret[1] = 'Эмильо';
  }

  let secretObject = { firstName: secret[0], lastName: secret[1] };
